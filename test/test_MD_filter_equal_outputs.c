...
int main(int argc, char** argv) {
    ...
    if ( loaded_data ){
        ...
        IIR_MD_t *filter = IIR_MD_create( n_coefs, N_SIGNALS, b_coefs, a_coefs );
        ...
        for ( int i=0; i < n_inputs; i++ ){
            ...
            this_output = IIR_MD_add_input(filter, multi_signal_input);
    ...
    printf( "SUCCESS: IIR_MD: Test passed: using IIR_MD filter with several signals.\n"
