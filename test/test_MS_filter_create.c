...
int main(int argc, char** argv) {
    ...
    if ( IIR_MS_create( 20, 0, b_coefs, a_coefs ) ){
        error = EXIT_FAILURE;
    ...
    if ( IIR_MS_create( 20, -10, b_coefs, a_coefs ) ){
        error = EXIT_FAILURE;
    ...
    if ( IIR_MS_create( 0, 5, b_coefs, a_coefs ) ){
        error = EXIT_FAILURE;
    ...
    if ( IIR_MS_create( 1, 5, b_coefs, a_coefs ) ){
        error = EXIT_FAILURE;
    ...
    if ( IIR_MS_create( -10, 5, b_coefs, a_coefs ) ){
        error = EXIT_FAILURE;
